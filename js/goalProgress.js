    ...
    $.fn.extend({
        goalProgress: function(options) {
            ...
            return this.each(function() {
                ...
                // background
                var goalbackground = defaults.background;
                ...
                // Generate the HTML
                var progressBar = '<div class="progressBar" style="background:' + goalbackground + '">&nbsp;</div>';
//                var progressBar = '<div class="progressBar" style="background:' + goalbackground + '">' + defaults.textBefore + currentAmountParsed + defaults.textAfter + '</div>';
